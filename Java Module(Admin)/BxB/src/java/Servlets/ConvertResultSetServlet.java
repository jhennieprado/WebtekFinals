...
public class ConvertResultSetServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet validSp = (ResultSet) request.getAttribute("ValidSp");
        ArrayList<ServiceProvider> valid = new ArrayList<>();
        ...
        request.setAttribute("ListOfValidSp", valid);
        RequestDispatcher dispatcher = request.getRequestDispatcher("SomeJspHere");
