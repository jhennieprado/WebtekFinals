...
public class DeactivateService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String [] ids = request.getParameterValues("services");
        /**
         * Deactivate the service as well right here
         * 
         */
        for(String id : ids){

            String query = "DELETE FROM services WHERE serviceid = ?";
            delete.deleteRow(query, id);
        }
        
        delete.closeConnection();
        String url = response.encodeRedirectURL("ValidServicesServlet");
