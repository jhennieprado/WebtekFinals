...
CREATE TABLE `appointments` (
  ...
  KEY `fk_amount_serviceamount_idx` (`amount`),
  KEY `fk_app_client_idx` (`clientno`),
  KEY `fk_app_spid_idx` (`spid`),
  KEY `sp_schedid` (`sp_schedid`),
  CONSTRAINT `fk_amount` FOREIGN KEY (`amount`) REFERENCES `services` (`serviceamount`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_app_client` FOREIGN KEY (`clientno`) REFERENCES `clients` (`clientno`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_app_spid` FOREIGN KEY (`spid`) REFERENCES `serviceproviders` (`spid`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `appointments` VALUES (2,17,'2017-05-11','2017-05-04 11:33:50','awdawd',500,110054,226483,226,'done');
...
CREATE TABLE `contact_list` (
  ...
  KEY `fk_contact_spid_idx` (`spid`),
  KEY `fk_clientno_idx` (`clientno`),
  CONSTRAINT `fk_clientno` FOREIGN KEY (`clientno`) REFERENCES `clients` (`clientno`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_contact_spid` FOREIGN KEY (`spid`) REFERENCES `serviceproviders` (`spid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ratings` (
  ...
  KEY `fk_rate_clientno_idx` (`clientno`),
  KEY `fk_rate_spid_idx` (`spid`),
  CONSTRAINT `fk_rate_clientno` FOREIGN KEY (`clientno`) REFERENCES `clients` (`clientno`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `fk_rate_spid` FOREIGN KEY (`spid`) REFERENCES `serviceproviders` (`spid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `serviceprovider_schedules` VALUES (17,226480,'MON','07:00:00','05:00:00','yes'),(18,226480,'WED','08:00:00','03:00:00','yes'),(204,226480,'FRI','07:00:00','05:00:00','yes'),(205,226481,'MON','07:00:00','05:00:00','yes'),(206,226481,'WED','08:00:00','03:00:00','yes'),(207,226481,'FRI','07:00:00','05:00:00','yes'),(208,226482,'MON','07:00:00','05:00:00','yes'),(209,226482,'WED','08:00:00','03:00:00','yes'),(210,226482,'FRI','01:00:00','05:00:00','yes'),(211,226483,'MON','07:00:00','05:00:00','yes'),(212,226483,'WED','08:00:00','03:00:00','yes'),(213,226483,'FRI','01:00:00','05:00:00','yes'),(214,226484,'MON','07:00:00','03:00:00','yes'),(215,226484,'WED','08:00:00','03:00:00','yes'),(216,226484,'FRI','01:00:00','05:00:00','yes'),(217,226485,'MON','07:00:00','03:00:00','yes'),(218,226485,'WED','08:00:00','03:00:00','yes'),(219,226485,'FRI','01:00:00','05:00:00','yes'),(220,226486,'MON','07:00:00','03:00:00','yes'),(221,226486,'WED','08:00:00','03:00:00','yes'),(222,226486,'FRI','01:00:00','05:00:00','yes'),(223,226487,'MON','07:00:00','03:00:00','yes'),(224,226487,'WED','08:00:00','03:00:00','yes'),(225,226487,'FRI','01:00:00','05:00:00','yes'),(226,226488,'MON','07:00:00','03:00:00','yes'),(227,226488,'WED','08:00:00','03:00:00','yes'),(228,226488,'FRI','01:00:00','05:00:00','yes'),(229,226489,'MON','07:00:00','03:00:00','yes'),(230,226489,'WED','08:00:00','03:00:00','yes'),(231,226489,'FRI','01:00:00','05:00:00','yes'),(232,226490,'TUE','07:00:00','03:00:00','yes'),(233,226490,'THU','08:00:00','03:00:00','yes'),(234,226490,'SAT','07:30:00','05:00:00','yes'),(235,226491,'TUE','07:00:00','03:00:00','yes'),(236,226491,'THU','08:00:00','03:00:00','yes'),(237,226491,'SAT','07:30:00','05:00:00','yes'),(238,226492,'TUE','07:00:00','03:00:00','yes'),(239,226492,'THU','08:00:00','03:00:00','yes'),(240,226492,'SAT','07:30:00','05:00:00','yes'),(241,226493,'TUE','07:00:00','03:00:00','yes'),(242,226493,'THU','08:00:00','03:00:00','yes'),(243,226493,'SAT','07:30:00','05:00:00','yes'),(244,226494,'TUE','07:00:00','03:00:00','yes'),(245,226494,'THU','08:00:00','03:00:00','yes'),(246,226494,'SAT','07:30:00','05:00:00','yes'),(247,226495,'TUE','07:00:00','03:00:00','yes'),(248,226495,'THU','08:00:00','03:00:00','yes'),(249,226495,'SAT','07:30:00','05:00:00','yes');
...
CREATE TABLE `sp_skills` (
  ...
  KEY `serviceID_idx` (`serviceid`),
  KEY `fk_spservice_spid_idx` (`spid`),
  CONSTRAINT `fk_skill` FOREIGN KEY (`serviceid`) REFERENCES `services` (`serviceid`),
...
-- Dump completed on 2017-05-05 21:13:04
