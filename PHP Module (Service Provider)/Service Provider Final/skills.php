...
<hr>
    ...
    <div class="container">
        ...
        <?php } ?>
            <a button class="btn btn-lg btn-primary btn-block" type="submit" href="addskills.php">Add Skills</a>
            <a button class="btn btn-lg btn-primary btn-block" type="submit" href="deleteSkills.php">Delete Skills</a>
        </div>
    </div>
            <script>
                function openNav() {
